...
<div className="flex flex-col justify-start py-10">
                    <div className="py-4">
                        ...
                        <input
                            ...
                            ref={nicknameRef}
                        />
                        {nicknameError && <p className="text-red-500 mt-2">Необходимо заполнить и использовать только буквы и цифры (макс. 30 символов).</p>}
                    </div>
                    <div className="py-4">
                        <p>Name</p>
                        <input
                            ...
                            ref={nameRef}
                        />
                        {nameError && <p className="text-red-500 mt-2">Необходимо заполнить и использовать только буквы (макс. 50 символов).</p>}
                    </div>
                    <div className="py-4">
                        <p>Sername</p>
                        <input
                            ...
                            placeholder="Your sername"
                            ref={sernameRef}
                        />
                        {sernameError && <p className="text-red-500 mt-2">Необходимо заполнить и использовать только буквы (макс. 50 символов).</p>}
                    </div>
                    ...
                    <div className="flex justify-between py-12">
                        <Link to="/" className="buttonstyle bg-[white] rounded border border-blue-400 text-[#3883f6]">Назад</Link>
                        <button className="buttonstyle" onClick={handleStart}>Далее</button>
                    </div>
                </div>
            </div>
        </div>
